...
public class Test {
	...
	public static void main(String[] args) {
		...
		CD[] cds = { new CD("101", "Happy", "Warner Bros"), new CD("102", "Sad", "Warner Bros"),
				new CD("103", "Jumpin", "Mills Bros"), new CD("104", "Frowning", "Mills Bros"),
				new CD("105", "Joy", "Warner Bros") };

		Book[] books = { new Book("1040A5", "Gone with the Wind", "Bob", "Gearhart"),
				new Book("5241C3", "The Unhappy Indian", "Richard", "Steigert"),
				new Book("9982D1", "The Unseen Rock", "Stephen", "King"),
				new Book("1112E5", "Hunting", "Danielle", "Steele"), new Book("8008T4", "Overdrive", "Cougar", "Fox")
		...
		CheckoutRecord[] records = { new CheckoutRecord(), new CheckoutRecord(), new CheckoutRecord(),
				new CheckoutRecord(), new CheckoutRecord(), new CheckoutRecord(), new CheckoutRecord(),
				new CheckoutRecord(), new CheckoutRecord() };
		...
		LibraryMember[] members = { new LibraryMember("1001", "Hank", "Reynolds", "323-4556"),
